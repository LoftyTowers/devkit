...
| Angular | Angular platform rules (angular) | **Angular (contracts):**<br>`.devkit/contracts/angular/architecture-structure.md`<br><br>**Angular (checklists):**<br>`.devkit/checklists/angular/architecture-checklist.md` |
---
