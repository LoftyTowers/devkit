...
| Sql | SQL Server rules (sql) | **SQL Server (contracts):**<br>`.devkit/contracts/sql/sql-server-core.md`<br><br>**SQL Server (checklists):**<br>`.devkit/checklists/sql/sql-server.md`<br><br>**SQL Server (playbooks):**<br>`.devkit/playbooks/sql/sql-server-core.md` |
