...
| Sql | SQL Server rules (sql) | **SQL Server (contracts):**<br>`.devkit/contracts/sql/keys.md`<br>`.devkit/contracts/sql/relationships.md`<br>`.devkit/contracts/sql/data-types.md`<br>`.devkit/contracts/sql/constraints.md`<br>`.devkit/contracts/sql/computed-columns.md`<br>`.devkit/contracts/sql/sparse-columns.md`<br>`.devkit/contracts/sql/null-handling.md`<br>`.devkit/contracts/sql/indexing-and-access-paths.md`<br>`.devkit/contracts/sql/migrations.md`<br><br>**SQL Server (checklists):**<br>`.devkit/checklists/sql/sql-server.md`<br><br>**SQL Server (playbooks):**<br>`.devkit/playbooks/sql/index-design.md`<br>`.devkit/playbooks/sql/data-types.md`<br>`.devkit/playbooks/sql/constraints.md`<br>`.devkit/playbooks/sql/schema-evolution.md`<br>`.devkit/playbooks/sql/authority-boundaries.md`<br><br>**SQL Server (how-to):**<br>`.devkit/how-to/sql/row-locators-and-lookups.md`<br>`.devkit/how-to/sql/filtered-unique-indexes.md`<br>`.devkit/how-to/sql/migration-scripting.md`<br>`.devkit/how-to/sql/migration-transactions.md`<br>`.devkit/how-to/sql/efcore-seeding.md`<br><br>**Artefacts & Encapsulation (Blob E):**<br>`.devkit/contracts/sql/stored-procedures.md`<br>`.devkit/contracts/sql/dynamic-sql-and-identifiers.md`<br>`.devkit/contracts/sql/indexed-views.md`<br>`.devkit/contracts/sql/scalar-udf-inlining.md`<br>`.devkit/contracts/sql/triggers.md`<br>`.devkit/contracts/sql/temporal-tables.md`<br>`.devkit/contracts/sql/cross-database-ownership-chaining.md`<br>`.devkit/contracts/sql/soft-delete-authority-boundary.md`<br>`.devkit/playbooks/sql/stored-procedures-calls.md`<br>`.devkit/playbooks/sql/views.md`<br>`.devkit/playbooks/sql/indexed-views.md`<br>`.devkit/playbooks/sql/functions.md`<br>`.devkit/playbooks/sql/triggers.md`<br>`.devkit/playbooks/sql/temporal-tables.md`<br>`.devkit/playbooks/sql/permissions-and-ownership-chaining.md`<br>`.devkit/playbooks/sql/soft-delete.md`<br>`.devkit/playbooks/sql/ef-core-integration.md`<br>`.devkit/how-to/sql/ef-core-result-shape-contracts.md`<br>`.devkit/how-to/sql/ef-core-stored-procedure-conventions.md`<br>`.devkit/checklists/sql/sql-server.md` |
