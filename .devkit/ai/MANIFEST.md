...
| Angular | Angular platform rules (angular) | **Angular (contracts):**<br>`.devkit/contracts/angular/architecture-structure.md`<br>`.devkit/contracts/angular/external-patterns.md`<br><br>**Angular (checklists):**<br>`.devkit/checklists/angular/architecture-checklist.md`<br><br>**Angular (playbooks):**<br>`.devkit/playbooks/angular/project-organization.md`<br>`.devkit/playbooks/angular/component-di-architecture.md`<br>`.devkit/playbooks/angular/change-detection-reactivity.md`<br>`.devkit/playbooks/angular/bundle-loading-optimization.md`<br><br>**Angular (how-to):**<br>`.devkit/how-to/angular/virtual-scrolling.md` |
---
