...
| Task Area | Intent | Files to load (in order) |
|---|---|---|
| Dotnet | Composition root changes (dotnet) | **General (contracts):**<br>`.devkit/contracts/general/dependency-injection.md`<br><br>**Dotnet override (contracts):**<br>`.devkit/contracts/dotnet/dependency-injection.md`<br><br>**Dotnet (how-to):**<br>`.devkit/how-to/dotnet/composition-root.md`<br><br>**General (playbooks):**<br>`.devkit/playbooks/general/operational-entrypoint-decision-matrix.md` |
