...
| Sql | Blob H - Statement Batches (sql) | **SQL Server (contracts):**<br>`.devkit/contracts/sql/statement-batches.md`<br>`.devkit/contracts/sql/statement-termination.md`<br>`.devkit/contracts/sql/validation-authority.md`<br>`.devkit/contracts/sql/verification-scripts-non-requirements.md`<br><br>**SQL Server (playbooks):**<br>`.devkit/playbooks/sql/handling-editor-diagnostics.md`<br>`.devkit/playbooks/sql/executing-scripts-without-go-support.md`<br>`.devkit/playbooks/sql/tsql-formatting-conventions.md`<br>`.devkit/playbooks/sql/verification-scripts-batch-safety.md`<br><br>**SQL Server (how-to):**<br>`.devkit/how-to/sql/statement-termination-patterns.md`<br>`.devkit/how-to/sql/batch-separators-go-aware-clients.md`<br>`.devkit/how-to/sql/sqlcmd-batch-separator-configuration.md`<br>`.devkit/how-to/sql/ssdt-go-handling.md` |
---
