...
| Angular | Angular platform rules (angular) | **Angular (contracts):**<br>`.devkit/contracts/angular/architecture-structure.md`<br>`.devkit/contracts/angular/external-patterns.md`<br>`.devkit/contracts/angular/state-management.contract.md`<br>`.devkit/contracts/angular/testing-standards.contract.md`<br>`.devkit/contracts/angular/security-requirements.contract.md`<br><br>**Angular (checklists):**<br>`.devkit/checklists/angular/architecture-checklist.md`<br>`.devkit/checklists/angular/state-management-checklist.md`<br><br>**Angular (playbooks):**<br>`.devkit/playbooks/angular/project-organization.md`<br>`.devkit/playbooks/angular/component-di-architecture.md`<br>`.devkit/playbooks/angular/change-detection-reactivity.md`<br>`.devkit/playbooks/angular/bundle-loading-optimization.md`<br>`.devkit/playbooks/angular/migrating-to-signals.playbook.md`<br>`.devkit/playbooks/angular/implementing-rxjs-patterns.playbook.md`<br>`.devkit/playbooks/angular/comprehensive-testing-strategy.playbook.md`<br><br>**Angular (how-to):**<br>`.devkit/how-to/angular/virtual-scrolling.md`<br>`.devkit/how-to/angular/reactive-state-with-signals.how-to.md`<br>`.devkit/how-to/angular/rxjs-operator-patterns.how-to.md` |
---
