...
- If multiple routes apply, load the union in the order listed (contracts -> checklists -> how-to).
- If unsure, start with Foundation, then add the most specific checklist or how-to.
...
| Review | Package guard (dotnet) | **Dotnet override (contracts):**<br>`.devkit/contracts/dotnet/package-management.md`<br>`.devkit/contracts/dotnet/libraries.md`<br><br>**Dotnet (checklists):**<br>`.devkit/checklists/dotnet/package-guard.md` |
...
| Task Area | Intent | Files to load (in order) |
|---|---|---|
| Dotnet | Composition root changes (dotnet) | **General (contracts):**<br>`.devkit/contracts/general/dependency-injection.md`<br><br>**Dotnet override (contracts):**<br>`.devkit/contracts/dotnet/dependency-injection.md`<br><br>**Dotnet (how-to):**<br>`.devkit/how-to/dotnet/composition-root.md` |
