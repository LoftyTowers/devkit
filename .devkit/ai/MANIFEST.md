...
| Sql | Blob H - Statement Batches (sql) | **SQL Server (contracts):**<br>`contracts/sql/statement-batches.md`<br>`contracts/sql/validation-authority.md`<br>`contracts/sql/verification-scripts-non-requirements.md`<br><br>**SQL Server (playbooks):**<br>`playbooks/sql/handling-editor-diagnostics.md`<br>`playbooks/sql/executing-scripts-without-go-support.md`<br>`playbooks/sql/verification-scripts-batch-safety.md`<br><br>**SQL Server (how-to):**<br>`how-to/sql/batch-separators-go-aware-clients.md`<br>`how-to/sql/sqlcmd-batch-separator-configuration.md`<br>`how-to/sql/ssdt-go-handling.md` |
---
